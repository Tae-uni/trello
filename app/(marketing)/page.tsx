  ...
  return (
    <div className="flex items-center justify-center flex-col">
      <div className={cn(
        ...
        <div className="mb-4 flex items-center border shawdow-sm p-4 bg-amber-100 text-amber-700 rounded-full uppercase">
          {/* This Medal from lucid-react */}
